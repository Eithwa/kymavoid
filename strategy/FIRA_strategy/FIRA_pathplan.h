...
public:
    ...
    double kp,ki,kd;
    void Pub_route();
    double Artificial_field(ScanInfo inner, ScanInfo outer, int main_vec, int close_dis, int RedLine, int red_dis_average, int dangerous_dis, int red_line_dangerous_dis, int condition);
    //=====================
